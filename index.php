                ...
                <div class="col-md-10 content">
                    ...
                    <div class="row">
                        <div class="col-md-12 welcome_part">
                            <p><span>Welcome Mr.</span> Sajedul Atif</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid footer_part">
            <div class="row">
                ...
                <div class="col-md-10 copyright">
                    <p>Copyright &copy; 2025 | All rights reserved by Dashboard | Development By <a href="#https://sajedulatif.com" target="_blank">Rasel Islam.</a></p>
                </div>
                <div class="clr"></div>
            </div>
        </div>
